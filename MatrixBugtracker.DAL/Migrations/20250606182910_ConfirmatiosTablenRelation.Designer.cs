...
namespace MatrixBugtracker.DAL.Migrations
{
    ...
    [Migration("20250606182910_ConfirmatiosTablenRelation")]
    partial class ConfirmatiosTablenRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MatrixBugtracker.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "vfQX91Bkm0ydSzEa+SxS6AJXQCBhPSFy65CDuZnjXTDnxmWBh9yn04sNtV/8v4dc",
                            Role = (byte)1
                        });
                });
