...
namespace MatrixBugtracker.DAL.Migrations
{
    ...
    [Migration("20250701130352_TextForUserNotification")]
    partial class TextForUserNotification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MatrixBugtracker.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "IOzmEm+FF+LIXZu92+uMCi4sEBMDLm7+162zgsJzFNNon/P/88nkC0DNmts6wVhn",
                            Role = (byte)1
                        });
                });
