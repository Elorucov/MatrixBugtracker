...
namespace MatrixBugtracker.DAL.Migrations
{
    ...
    [Migration("20250506192727_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatrixBugtracker.DAL.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "Name" }, "UQ_RoleName")
                        .IsUnique();
            ...
            modelBuilder.Entity("MatrixBugtracker.DAL.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("MatrixBugtracker.DAL.Entities.UserRole", b =>
                {
                    b.HasOne("MatrixBugtracker.DAL.Entities.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .IsRequired()
                        .HasConstraintName("FK_UR_Role");

                    b.HasOne("MatrixBugtracker.DAL.Entities.Role", null)
                        .WithMany("UserRoles")
                    ...
                    b.HasOne("MatrixBugtracker.DAL.Entities.User", null)
                        .WithMany("UserRoles")
